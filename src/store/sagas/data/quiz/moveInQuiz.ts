...
//       const result = chessFocusing.move({from: from as Square, to: to as Square});
//       if (result){
...
function* moveInQuiz(action: actions.data.quiz.type__MOVE_IN_QUIZ) {
